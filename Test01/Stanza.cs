...
namespace Test01
{
    public class Stanza
    {
        ...
        public void NuovaStanza(int contPagina, int id)
        {
            ...
            int contPaginaAtt = 1;
            var Test = new ExcelReader(@"C:\UTIL_EXTRA\Test.xlsx");
            ...
            {
                if (contPagina == contPaginaAtt)                                        //Controllo se il Foglio attuale è quello cercato (contPagina)
                {
                    int RigaAtt = 1;
